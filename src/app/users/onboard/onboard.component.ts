...
export class OnboardComponent implements OnInit {
  ...
  async saveOnboard() {
    ...
    inputData.append('dto',JSON.stringify(dto));
    inputData.append('profileImage',this.pathFile);
    
console.log(inputData);
const req = new HttpRequest('POST', 'http://localhost:8080/employee/create', inputData, {
  reportProgress: true,
  responseType: 'text'
}
);
